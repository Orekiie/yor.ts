---
title: Yor.ts | classes/UserContextMenuCommandInteraction
icon: "code"
sidebarTitle: UserContextMenuCommandInteraction
---
[yor.ts](../README) / [Exports](../modules) / UserContextMenuCommandInteraction
...
- [constructor](UserContextMenuCommandInteraction#constructor)

### Properties

- [applicationId](UserContextMenuCommandInteraction#applicationid)
- [client](UserContextMenuCommandInteraction#client)
- [interactionId](UserContextMenuCommandInteraction#interactionid)
- [raw](UserContextMenuCommandInteraction#raw)
- [targetId](UserContextMenuCommandInteraction#targetid)
- [token](UserContextMenuCommandInteraction#token)

### Methods

- [decorate](UserContextMenuCommandInteraction#decorate)
- [defer](UserContextMenuCommandInteraction#defer)
- [deleteReply](UserContextMenuCommandInteraction#deletereply)
- [editReply](UserContextMenuCommandInteraction#editreply)
- [fetchReply](UserContextMenuCommandInteraction#fetchreply)
- [followUp](UserContextMenuCommandInteraction#followup)
- [reply](UserContextMenuCommandInteraction#reply)
- [replyModal](UserContextMenuCommandInteraction#replymodal)
...
• **new UserContextMenuCommandInteraction**(`client`, `data`): [`UserContextMenuCommandInteraction`](UserContextMenuCommandInteraction)
...
| :------ | :------ | :------ |
| `client` | [`YorClient`](YorClient) | the YorClient object |
...
[src/structures/Contexts/ContextMenu/UserContextMenuCommandInteraction.ts:15](https://github.com/OreOreki/yor.ts/blob/e005218/src/structures/Contexts/ContextMenu/UserContextMenuCommandInteraction.ts#L15)
...
[src/structures/Contexts/ContextMenu/UserContextMenuCommandInteraction.ts:27](https://github.com/OreOreki/yor.ts/blob/e005218/src/structures/Contexts/ContextMenu/UserContextMenuCommandInteraction.ts#L27)
