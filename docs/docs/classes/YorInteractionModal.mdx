...
• **execute**: (`context`: [`ModalContext`](ModalContext)) => `void` \| `Promise`\<`void`\>
...
[src/structures/YorInteractionModal.ts:7](https://github.com/OreOreki/interactions.ts/blob/8ac09b8/src/structures/YorInteractionModal.ts#L7)
...
[src/structures/YorInteractionModal.ts:6](https://github.com/OreOreki/interactions.ts/blob/8ac09b8/src/structures/YorInteractionModal.ts#L6)
