...
[src/structures/YorContextMenuCommand.ts:19](https://github.com/OreOreki/yor.ts/blob/e005218/src/structures/YorContextMenuCommand.ts#L19)
...
[src/structures/YorContextMenuCommand.ts:20](https://github.com/OreOreki/yor.ts/blob/e005218/src/structures/YorContextMenuCommand.ts#L20)
